...
- [x] OS-level clipboard integration test: trigger a real paste in a running app → assert single `:user/message` dispatched, history stores one entry with full text (manual — verified in running app)
